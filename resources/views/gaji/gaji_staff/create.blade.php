...
<section class="content-header">
    <h1>
        <a href="gaji/gaji-staff" >Gaji Staff</a> <i class="fa fa-angle-double-right" ></i> New
    </h1>
</section>
...
<section class="content">
    <div class="box box-solid">
        <form role="form" method="POST" action="gaji/gaji-staff/save" >
        ...
        <div class="box-footer" >
            ...
            <a class="btn btn-danger" id="btn-cancel-save" href="gaji/gaji-staff" ><i class="fa fa-close" ></i> Close</a>
        </div>
        </form>
    </div><!-- /.box -->
