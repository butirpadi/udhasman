...
<section class="content-header">
    <h1>
        <a href="gaji/gaji-driver" >Gaji Driver</a> <i class="fa fa-angle-double-right" ></i> New
    </h1>
</section>
...
<section class="content">
    <div class="box box-solid">
        <form role="form" method="POST" action="gaji/gaji-driver/save" >
                ...
                <div class="box-body">
                    <div class="row" >
                        <div class="col-xs-6" >
                            ...
                            <div class="form-group">
                                <label >Driver</label>
                                {!! Form::select('partner',$partners,null,['class'=>'form-control select2','required']) !!}
                            </div>
        ...
        <div class="box-footer" >
            ...
            <a class="btn btn-danger" id="btn-cancel-save" href="gaji/gaji-driver" ><i class="fa fa-close" ></i> Close</a>
        </div>
        </form>
    </div><!-- /.box -->
