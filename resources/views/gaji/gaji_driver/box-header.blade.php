<div class="box-header with-border" >
    <a class="btn btn-primary" id="btn-add" href="gaji/gaji-driver/create" ><i class="fa fa-plus-circle" ></i> Create</a>
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
          <li><a href="gaji/gaji-driver/filter/state/draft">State : Draft</a></li>
          <li><a href="gaji/gaji-driver/filter/state/open">State : Open</a></li>
    ...
    <div class="pull-right" >
        <div class="box-tools" style="margin-top: 6px;">
            <form method="GET" action="gaji/gaji-driver/search" >
