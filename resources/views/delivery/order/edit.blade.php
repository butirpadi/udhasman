...
<section class="content">
    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            <table class="table table-condensed no-border" id="table-do-master" >
                <tbody>
                    <tr>
                        <td class="col-lg-2">
                            <label>SO Ref#</label>
        ...
        <div class="box-footer" >
            @if($data->status != 'D')
                <a  class="btn btn-warning" href="delivery/order/validate/{{$data->id}}" id="btn-validate" ><i class="fa fa-check" ></i> Validate</a> &nbsp;&nbsp;&nbsp;
            @endif
