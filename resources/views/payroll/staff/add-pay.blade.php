...
<section class="content-header">
    <h1>
        ...
        <a href="payroll/payroll-staff/show-payroll-table/{{$tanggal_gaji}}/ST" >Payroll Staff</a>
        <i class="fa fa-angle-double-right" ></i>
        Edit Payroll
    </h1>
</section>
...
<section class="content">
    <div class="box box-solid">
        ...
        <div class="box-footer" >
          ...
          <a class="btn btn-danger" href="payroll/payroll-staff/show-payroll-table/{{$tanggal_gaji}}" ><i class="fa fa-close" ></i> Close</a>
        </div>
...
(function ($) {
  ...
  $('#btn-save-payroll').click(function(){
    ...
    var newform = $('<form>').attr('method','POST').attr('action','payroll/payroll-staff/insert-pay');
