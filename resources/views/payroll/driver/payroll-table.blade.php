...
<section class="content">
    ...
    <div class="box box-solid">
            ...
            <table class="table table-bordered table-condensed table-striped table-hover table-data" id="table-payroll" >
                ...
                <tbody>
                    ...
                    <tr data-rowid="{{$rownum}}" data-id="{{$dt->id}}">
                        ...
                        <td class="text-center" >
                            @if($dt->payroll)
                                {{$dt->tanggal_pembayaran_formatted}}
                            @endif
                        </td>
                        <td class="text-center" >
                            {{$dt->kode}}
                        ...
                        <td class="text-center" >
                            @if($dt->payroll)
                                @if($dt->payroll->status == 'P')
                                    <a class="btn btn-success btn-xs" href="payroll/payroll-driver/edit-pay/{{$dt->payroll->id}}" data-toggle="tooltip" data-title="Edit" ><i class="fa fa-edit" ></i></a>
                                @elseif($dt->payroll->status == 'O')
                                    <a class="btn btn-success btn-xs" href="payroll/payroll-driver/edit-pay/{{$dt->payroll->id}}" data-toggle="tooltip" data-title="Edit" ><i class="fa fa-edit" ></i></a>
                                @else
                                <a class="btn btn-primary btn-xs" href="payroll/payroll-driver/pay/{{$dt->id}}/{{$tanggal_penggajian}}" data-toggle="tooltip" data-title="Edit" ><i class="fa fa-edit" ></i></a>
                                    
                                @endif

                                {{-- BUTTON PRINT --}}
                                @if($dt->payroll->status == 'P')
                                    <a target="_blank" class="btn btn-danger btn-xs" data-toggle="tooltip" data-title="Print PDF"  href="payroll/payroll-driver/print-pdf/{{$dt->payroll->id}}" ><i class="fa fa-file-pdf-o" ></i></a>
                                    <a target="_blank" class="btn btn-primary btn-xs" data-toggle="tooltip" data-title="Print & Copy" href="payroll/payroll-driver/print-copy/{{$dt->payroll->id}}" ><i class="fa fa-copy" ></i></a>
                                    <a target="_blank" class="btn btn-warning btn-xs" data-toggle="tooltip" data-title="Direct Print" href="payroll/payroll-driver/print-direct/{{$dt->payroll->id}}" ><i class="fa fa-print" ></i></a>
                                @endif
                            @else
                                <a class="btn btn-primary btn-xs" href="payroll/payroll-driver/pay/{{$dt->id}}/{{$tanggal_penggajian}}" ><i class="fa fa-edit" ></i></a>
        ...
        <div class="box-footer" >
            <a class="btn btn-danger" href="payroll/payroll" ><i class="fa fa-close" ></i> Close</a>
        </div>
    </div><!-- /.box -->
