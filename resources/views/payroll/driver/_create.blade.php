...
<section class="content">
    <div class="box box-solid">
            ...
            <div class="row data-delivery hide" >
                ...
                {{-- <div class="col-lg-12" >
                    <button type="submit" class="btn btn-primary" id="btn-save" ><i class="fa fa-save" ></i> Save</button>
                            <a class="btn btn-danger" id="btn-cancel-save" ><i class="fa fa-close" ></i> <i class="fa fa-close" ></i> Close</a>
                </div> --}}
            </div>
        ...
        <div class="box-footer data-delivery hide" >
            <button type="submit" class="btn btn-primary" id="btn-save" ><i class="fa fa-save" ></i> Save</button>
            <a class="btn btn-danger" id="btn-cancel-save" href="payroll/driver" ><i class="fa fa-close" ></i> <i class="fa fa-close" ></i> Close</a>
        </div>
    </div><!-- /.box -->
