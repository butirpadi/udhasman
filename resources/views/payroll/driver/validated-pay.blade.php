...
<section class="content">
    <div class="box box-solid">
        ...
        <div class="box-footer" >
          <a class="btn btn-success" target="_blank" href="payroll/payroll-staff/print-pdf/{{$data->id}}" ><i class="fa fa-file-pdf-o" ></i> Print PDF</a>
          <a class="btn btn-success" target="_blank" href="payroll/payroll-staff/print-copy/{{$data->id}}" ><i class="fa fa-copy" ></i> Print & Copy</a>
          <a class="btn btn-success" target="_blank" href="payroll/payroll-staff/print-direct/{{$data->id}}" ><i class="fa fa-print" ></i> Direct Print</a>
