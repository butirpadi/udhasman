...
<section class="content">
 ...
 --}}                
        ...
        <div class="box-body">
            ...
            <table class="table no-border" id="table-do-master" >
                <tbody>
                    <tr>
                        <td class="col-lg-2">
        ...
        <div class="box-footer" >
            ...
            <a class="btn btn-danger" id="btn-cancel-save" href="sales/order/delivery/{{$data->sales_order_id}}" ><i class="fa fa-close" ></i> Close</a>
        </div>
    </div><!-- /.box -->
