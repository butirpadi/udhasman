...
<section class="content-header">
    <h1>
        ...
        <i class="fa fa-angle-double-right" ></i> New Pekerjaan
    </h1>
</section>
            ...
            <div class="row" >
                <div class="col-xs-6" >
                    <div class="form-group">
                        ...
                        <input type="text" name="customer" class="form-control" required autocomplete="off" readonly value="{{$customer->nama}}" />
                        <input type="hidden" name="customer_id" class="form-control" required autocomplete="off" readonly value="{{$customer->id}}" />
                ...
                <div class="col-xs-6" >
                    <div class="form-group">
                        ...
                        <input type="hidden" name="provinsi_id" class="form-control" required autocomplete="off"  />                     
                    </div>  
                    <div class="form-group">
                        <label>Kota/Kabupaten</label>
                         <input type="text" name="kabupaten" class="form-control" required autocomplete="off"  />
                        <input type="hidden" name="kabupaten_id" class="form-control" required autocomplete="off"  />
                    </div>  
                    <div class="form-group">
                        <label>Kecamatan</label>
                        <input type="text" name="kecamatan" class="form-control" required autocomplete="off"  />
                        <input type="hidden" name="kecamatan_id" class="form-control" required autocomplete="off"  />
                        
                    </div> 
                    <div class="form-group">
                        <label>Desa</label>
                        <input type="text" name="desa" class="form-control" required autocomplete="off"  />
                        <input type="hidden" name="desa_id" class="form-control" required autocomplete="off"  />
...
(function ($) {
    ...
    $('#btn-save').click(function(){
        ...
        if(nama != ""  ){
            var formdata = $('<form>').attr('method','POST').attr('action','master/customer/insert-pekerjaan');
