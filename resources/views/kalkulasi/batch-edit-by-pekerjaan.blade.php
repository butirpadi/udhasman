...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header with-border" >
            <h3 style="margin:0;padding:0;" >{{$data_pekerjaan->nama}}</h3>
        </div>
        <div class="box-body">
            <input type="hidden" name="karyawan_id" value="{{$data_pekerjaan->id}}"> 
            ...
            <table class="table table-condensed no-border table-master-header" >
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-xs-4" >
                            <?php $dp = $data_pekerjaan; ?>
                            {{ $dp->alamat != '' ? $dp->alamat : '-' }}
                            {{ $dp->desa != '' ? ', ' . $dp->desa : '' }}
                            {{ $dp->kecamatan != '' ? ', ' . $dp->kecamatan : '' }}
                            {{ $dp->kabupaten != '' ? ', ' . $dp->kabupaten : '' }}
                            {{ $dp->provinsi != '' ? ', ' . $dp->provinsi : '' }}
                        </td>
                        <td class="col-xs-2" >
