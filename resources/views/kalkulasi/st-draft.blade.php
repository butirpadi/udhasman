    ...
    <div class="box box-solid">
        ...
        <form name="formkalkulasi" action="kalkulasi/update" method="POST">
                ...
                <table id="table-product" class="table table-bordered table-condensed" >
                    <thead>
                        <tr>
                            ...
                            <th>KALKULASI</th>
                            <th>NOTA TIMBANG</th>
                            <th class="col-kubikasi hide">PANJANG</th>
                            <th class="col-kubikasi hide">LEBAR</th>
                            <th class="col-kubikasi hide">TINGGI</th>
                            <th class="col-kubikasi hide">VOLUME</th>
                            <th class="col-tonase hide">GROSS</th>
                            <th class="col-tonase hide">TARE</th>
                            <th class="col-tonase hide">NETTO</th>
                            <th class="col-ritase hide">QUANTITY</th>
                            <th>HARGA SATUAN</th>
                            <th>TOTAL</th>
                    ...
                    <tbody>
                        <tr  id="row-add-product"  >
                            ...
                            <td>
                                ...
                                {!! Form::select('kalkulasi',['RITASE'=>'RITASE','KUBIKASI'=>'KUBIKASI','TONASE'=>'TONASE'],null,['class'=>'form-control']) !!}
                            </td>
                            <td >
                                <input type="text" class="form-control" name="nota_timbang">
                            </td>
                            <td class="col-kubikasi hide col-xs-1" >
                                <input type="text" name="panjang" class="form-control uang text-right">
                            </td>
                            <td class="col-kubikasi hide col-xs-1">
                                <input type="text" name="lebar" class="form-control uang text-right">
                            </td>
                            <td class="col-kubikasi hide col-xs-1">
                                <input type="text" name="tinggi" class="form-control uang text-right">
                            </td>
                            <td class="col-kubikasi hide col-xs-1">
                                <input type="text" name="volume" class="form-control uang text-right" readonly>
                            </td>
                            <td class="col-tonase hide col-xs-1" >
                                <input type="text" name="gross" class="form-control uang text-right">
                            </td>
                            <td class="col-tonase hide col-xs-1">
                                <input type="text" name="tare" class="form-control uang text-right">
                            </td>
                            <td class="col-tonase hide col-xs-1">
                                <input type="text" name="netto" class="form-control uang text-right" readonly >
                            </td>
                            <td class="col-ritase hide col-xs-1">
                                <input type="text" name="quantity" class="form-control text-right" value="1" readonly="readonly" >
                            </td>
                            <td class="col-xs-2">
                                <input type="text" name="harga_satuan" required class="form-control text-right uang">
                            </td>
                            <td class="col-xs-2">
            ...
            <div class="box-footer" >
                ...
                {{-- <a class="btn btn-success pull-right"  id="btn-validate" href="pengiriman/validate/{{$data_kalkulasi->id}}" ><i class="fa fa-check" ></i> Validate</a> --}}
