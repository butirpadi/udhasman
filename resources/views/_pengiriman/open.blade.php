                ...
                <table class="table table-condensed no-border table-master-header" >
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-lg-4" >
                                <input required type="text" name="tanggal" value="{{$data_pengiriman->tanggal_format}}" class="form-control input-tanggal">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                {!! Form::select('lokasi_galian',$select_lokasi_galian,$data_pengiriman->lokasi_galian_id,['class'=>'form-control','required']) !!}
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            ...
                            <td>
                                {!! Form::select('driver',$select_driver,$data_pengiriman->karyawan_id,['class'=>'form-control','required']) !!}
                            </td>
                        </tr>
                    </tbody>
                </table>
