...
<section class="content">
    ...
    <div class="box box-solid">
        ...
        <div class="box-footer" >
            @if($data->status == 'O')
              <button class="btn btn-primary" id="btn-reg-payment" data-href="invoice/supplier/bill/reg-payment/{{$data->id}}" ><i class="fa fa-upload" ></i> Register Payment</button>
            ...
            <a class="btn btn-danger" href="invoice/supplier/bill" ><i class="fa fa-close" ></i> Close</a>
        </div>
    </div><!-- /.box -->
