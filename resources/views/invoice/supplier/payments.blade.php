...
<section class="content">
    ...
    <div class="box box-solid">
                   ...
                   @foreach($payments as $dt)
                        <tr>
                            ...
                            <td class="text-center" >
                                ...
                                <a class="btn btn-danger btn-xs btn-delete-payment" href="invoice/supplier/bill/payment/delete/{{$dt->id}}" ><i class="fa fa-trash" ></i></a>
                            </td>
                        </tr>
        ...
        <div class="box-footer" >
            <a class="btn btn-danger" href="invoice/supplier/bill/edit/{{$bill->id}}" ><i class="fa fa-close" ></i> Close</a>
        </div>
    </div><!-- /.box -->
