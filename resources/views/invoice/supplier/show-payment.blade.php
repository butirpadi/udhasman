...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >
            {{-- <a class="btn btn-primary" style="margin-top:0;" id="btn-reg-payment" href="sales/order/reg-payment/{{$so_master->id}}" ><i class="fa fa-upload" ></i> Register Payment</a> --}}
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="5" >
                                ...
                                <a class="btn btn-danger" id="btn-cancel" href="invoice/supplier/bill/edit/{{$data->id}}" ><i class="fa fa-close" ></i> Close</a> --}}
                                <a class="btn btn-danger" href="invoice/supplier/bill/payments/{{$data->supplier_bill_id}}" ><i class="fa fa-close" ></i> Close</a>
                            </td>
                        </tr>
