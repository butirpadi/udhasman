    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_2">
                <form name="form-group-report" method="POST" action="report/hutang/submit" >
                    <div class="row" >
                        <div class="col-xs-6" >
                        ...
                        <div class="col-xs-6" >
                            ...
                            <!-- <div class="form-group" id="input-customer" >
                                ...
                                {!! Form::select('type',['lain'=>'Hutang Lain-lain', 'pembelian'=>'Hutang Pembelian'],null,['class'=>'form-control select2']) !!}
                            </div> -->
...
(function ($) {
    ...
    $('#btn-print-pdf').click(function(){
        ...
        // if(form.find('select[name=tipe_report]').val() == 'summary' ){
            form.attr('action','report/hutang/submit-pdf');            
        // }else{
    ...
    $('#btn-excel').click(function(){
        ...
        form.find('select[name=partner]').val($('form[name=form-group-report]').find('select[name=partner]').val());
        form.find('select[name=type]').val($('form[name=form-group-report]').find('select[name=type]').val());
        form.attr('action','report/hutang/submit-excel');       
        form.submit();
        form.remove();
    });
