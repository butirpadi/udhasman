<html>
	...
	<body>
		...
		<table class="table-product" style="font-size:10pt;width: 100%;font-family: arial;"  >
			<thead>
				<tr>
					<th colspan="8" style="text-align: center;border:none;" >LAPORAN OPERASIONAL ALAT BERAT</th>
				</tr>
				<tr  >
					<th colspan="8" style="text-align: center; border:none;" >Periode : {{$tanggal_awal . ' / ' . $tanggal_akhir}}</th>
				</tr>
				<tr>
				...
				@foreach($data_group as $pg)
					...
					<tr>
						@if($tipe_report == 'detail')
							<td colspan="8" style="border:1px solid #000;{{!$excel?'background-color: whitesmoke;':''}}" >
								<strong>
