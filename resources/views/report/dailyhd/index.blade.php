    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_2">
                <form target="_blank" name="form-group-report" method="POST" action="report/dailyhd/submit" >
                    <div class="row" >
                        <div class="col-xs-6" >
...
(function ($) {
    ...
    $('#btn-print-pdf').click(function(){
        ...
        form.attr('action','report/dailyhd/submit-pdf');            
        form.submit();
        form.remove();
    });
    ...
    $('#btn-excel').click(function(){
        ...
        form.find('select[name=pengawas]').val($('form[name=form-group-report]').find('select[name=pengawas]').val());
        form.find('select[name=operator]').val($('form[name=form-group-report]').find('select[name=operator]').val());
        form.attr('action','report/dailyhd/submit-excel');       
        form.submit();
        form.remove();
    });
