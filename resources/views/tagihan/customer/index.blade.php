...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header with-border" >
            ...
            <a class="btn btn-primary" href="tagihan-customer/cetak-tagihan" ><i class="fa fa-print" ></i> Cetak Daftar Tagian</a>
            <!-- <a class="btn btn-success" ><i class="fa fa-download" ></i> Pembayaran</a> -->
