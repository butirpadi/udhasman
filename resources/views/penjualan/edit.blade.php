...
<section class="content">
    ...
    <div class="box box-solid">
            ...
            <table class="table table-condensed no-border table-master-header" >
                <tbody>
                    <tr>
                        ...
                        <td class="col-lg-4" >
                            <input type="text" name="customer" autofocus class="form-control " data-customerid="{{$data_master->customer_id}}" value="{{$data_master->nama_customer}}" readonly required>
                        </td>
                        <td class="col-lg-2" >
        ...
        <div class="box-footer" >
            ...
            <a class="btn btn-success pull-right"  id="btn-validate" href="penjualan/validate/{{$data_master->id}}" ><i class="fa fa-check" ></i> Validate</a>
        </div>
    </div><!-- /.box -->
...
(function ($) {
    ...
    $('#btn-save').click(function(){
        ...
        if(so_master.customer_id != "" 
            ...
            var newform = $('<form>').attr('method','POST').attr('action','penjualan/update');
