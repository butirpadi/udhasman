...
<section class="content">
    <div class="box box-solid" >
        <form enctype="multipart/form-data" method="POST" action="master/supplier/update" >
                    ...
                    <div class="col-xs-5" >
                        <div class="radio hide">
                            <label class="radio-inline" >
                                <input type="radio" name="partner_type" value="partner" {{$data->supplier == 'N' && $data->supplier == 'N' && $data->supplier == 'N' && $data->supplier == 'N' ? 'checked':'' }} >
                                Supplier
                            </label>
                            <label class="radio-inline" >
