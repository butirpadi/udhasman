...
<section class="content">
    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            <div class="row" >
                <div class="col-sm-10 col-md-10 col-lg-10">
                    ...
                    <table class="table no-border" id="table-master-so" >
                        <tbody>
                            <tr>
                                <td class="col-lg-2">
        ...
        <div class="box-footer" >
            <button class="btn btn-warning" id="btn-cancel-order" data-href="purchase/order/cancel-order/{{$data_master->id}}" ><i class="fa fa-reply" ></i> Cancel Order</button>
            &nbsp;&nbsp;&nbsp;
