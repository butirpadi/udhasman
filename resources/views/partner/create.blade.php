...
<section class="content-header">
    <h1>
        <a href="master/partner" >Data Partner</a>
...
<section class="content">
    <div class="box box-solid" >
        <form enctype="multipart/form-data" method="POST" action="master/partner/insert" >
                ...
                <div class="row" >
                    <div class="col-xs-5" >
                        <div class="radio hide">
                            ...
                            <label class="radio-inline" >
                                <input type="radio" name="partner_type" value="customer" >
                                Customer
                            </label>
                            <label class="radio-inline" >
            ...
            <div class="box-footer">
                ...
                <a class="btn btn-danger" href="master/partner" ><i class="fa fa-close" ></i> Close</a>
            </div>
        </form>
    </div>
</section><!-- /.content -->
...
<script type="text/javascript">
    (function ($) {
        ...
        $(":radio[value=partner]").prop('checked',true).trigger('change');
