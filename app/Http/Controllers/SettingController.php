...
class SettingController extends Controller
{
	...
	public function update(Request $req){
		return \DB::transaction(function()use($req){
			...
			if(isset($req->pengiriman_prefix)){
				\DB::table('appsetting')
			...
			if(isset($req->operasional_alat_prefix)){
				\DB::table('appsetting')
			...
			if(isset($req->cashbook_debit_prefix)){
				\DB::table('appsetting')
			...
			if(isset($req->cashbook_credit_prefix)){
				\DB::table('appsetting')
			...
			if(isset($req->master_payment_in_prefix)){
				\DB::table('appsetting')
			...
			if(isset($req->paging_item_number)){
				\DB::table('appsetting')
